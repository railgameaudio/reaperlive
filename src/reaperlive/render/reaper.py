...
def write_project(path: Path, stems: Sequence[Stem], grid: BeatGrid,
    ...
    project.line(f"TIMEMODE 1 5 -1 30 0 0 -1")
    ...
    project.line(f"RECMODE 1")
    project.line(f"SMPTESYNC 0 30 100 40 1000 300 0 0 1 0 0")
    project.line(f"LOOP 0")
    project.line(f"LOOPGRAN 0 4")
    ...
    project.line(f"SELECTION 0 0")
    project.line(f"SELECTION2 0 0")
